...
#define LAYER_NO_REDRAW (0x000000001ull << 32)
...
struct SyscallResult SyscallDemandPages(const size_t num_pages, int flags);
struct SyscallResult SyscallMapFile(int fd, size_t* file_size, const int flags);
